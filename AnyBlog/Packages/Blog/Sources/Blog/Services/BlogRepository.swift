...
class BlogPostRepositoryImp : BlogRepository{
    ...
    func fetchBlogPosts(apiKey: String) -> AnyPublisher<[BlogPost], Error> {
        ...
        let endPoint = nextPageToken == nil ? "blogs/6839959377168934742/posts?key=AIzaSyCWptosPBKqROY12Z6NtPaDLHgYA86fjok" : "blogs/6839959377168934742/posts?key=AIzaSyCWptosPBKqROY12Z6NtPaDLHgYA86fjok&pageToken=\(nextPageToken!)"
